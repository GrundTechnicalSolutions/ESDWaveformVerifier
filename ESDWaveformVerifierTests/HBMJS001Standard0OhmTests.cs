...
namespace ESDWaveformVerifierTests
{
    ...
    public class HBMJS001Standard0OhmTests
    {
        ...
        public void HBMJS0010OhmPositiveNoNoiseCompensationTest()
        {
            ...
            Assert.AreEqual(0.000000007889, hbm0OhmJS001Standard.RiseTimeValue, 0.000000000010);
            ...
            Assert.AreEqual(0.00000016031, hbm0OhmJS001Standard.DecayTimeValue, 0.000000000010);
            ...
            Assert.AreEqual(0.09823, hbm0OhmJS001Standard.TotalRingPercentValue, 0.0001);
        ...
        public void HBMJS0010OhmNegativeNoNoiseCompensationTest()
        {
            ...
            // Assert that Decay Time is within 10ps of expected
            Assert.AreEqual(0.00000016767, hbm0OhmJS001Standard.DecayTimeValue, 0.000000000010);
            ...
            // Assert that Decay Time is within 0.01% of expected
            Assert.AreEqual(0.03586, hbm0OhmJS001Standard.TotalRingPercentValue, 0.0001);
